...
<div class="relative flex flex-col min-h-screen min-w-screen" id="contact">
    ...
    <p class="absolute text-2xl sm:text-4xl md:text-5xl underline decoration-accent-red underline-offset-6 leading-[0.5] p-2 md:p-8 reveal" use:inView={reveal}>Contact</p>

    <div class="flex flex-col grow justify-center items-center gap-12">
        <p class="font-bold text-6xl sm:text-7xl pl-12 md:text-8xl tracking-tight self-end md:mx-auto leading-[0.7] reveal" use:inView={reveal}>Let's work together.</p>
        ...
        >
            ...
            <div class="flex flex-col gap-2 reveal" use:inView={reveal} style="--reveal-delay: 60ms;">
            ...
            <div class="flex flex-col gap-2 reveal" use:inView={reveal} style="--reveal-delay: 120ms;">
                <label for="email" class="text-lg font-semibold">Email</label>
                <input id="email" type="email" name="email" class="border border-border-gray bg-accent-gray p-2 rounded" placeholder="Enter your email" required />
            </div>
            <div class="flex flex-col gap-2 reveal" use:inView={reveal} style="--reveal-delay: 180ms;">
                <label for="message" class="text-lg font-semibold">Message</label>
                <textarea id="message" name="message" class="border border-border-gray bg-accent-gray p-2 rounded" placeholder="Enter your message" rows="5" required></textarea>
            </div>
            <button
                    type="submit"
                    class="bg-accent-red font-bold text-xl md:text-2xl self-center md:w-1/4 text-white py-2 mt-4 px-4 rounded cursor-pointer reveal"
                    use:inView={reveal}
    ...
    <footer class="flex flex-row gap-4 self-center p-2 md:p-8 bg-accent-gray w-full justify-center reveal" use:inView={reveal} style="--reveal-delay: 120ms;">
