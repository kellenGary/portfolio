...
<div class="relative flex min-h-screen min-w-screen">
    ...
    <img src="./about/m6.png"
         class="absolute right-0 top-20 hidden sm:block w-auto max-h-[20vh] max-w-[20vw] object-contain transform scale-[0.85] sm:scale-90 md:scale-100"
         alt="m6"
    />

    <img src="./about/m7.png"
         class="absolute -z-1 top-70 hidden sm:block w-auto max-h-[20vh] max-w-[20vw] object-contain transform scale-[0.85] sm:scale-90 md:scale-100"
         alt="m7"
    />
    ...
    <div class="flex flex-col-reverse md:flex-row justify-center gap-12 md:gap-4 md:justify-around items-center grow">
        <div class="flex flex-col gap-4 sm:gap-8 w-full sm:w-[60dvw] md:w-fit">
            ...
            <div class="flex flex-col gap-2">
                <p class="text-center sm:text-left text-xl sm:text-2xl">External Affiliations</p>
                <div class="flex flex-row items-center sm:gap-4 bg-accent-gray sm:py-4 pl-4 sm:rounded-lg">
...
<!--                <div class="flex flex-row items-center gap-2 p-2 sm:gap-4 bg-accent-gray sm:py-4 sm:px-4 rounded-lg">-->
